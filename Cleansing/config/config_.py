...
LS_ROOT = ['LAND_TYPE','LEGAL_STATUS','PRO_DIRECTION',\
           'CITY','DISTRICT','WARD','STREET',"FULL_ADDRESS","LAT","LON","DETAILED_BRIEF",\
           'USED_SURFACE','USED_SURFACE_UNIT','USED_SURFACE_ORIGINAL','SURFACE','SURFACE_UNIT','SURFACE_ORIGINAL','PRICE','PRICE_UNIT','PRICE_ORIGINAL',\
           'PRO_LENGTH','PRO_WIDTH','ALLEY_ACCESS', 'FRONTAGE',\
           #'DEALER_TEL','DEALER_EMAIL','DEALER_JOINED_DATE','DATE_ORIGINAL',\
            "ADS_DATE",'ADS_DATE_ORIGINAL'
          ]
...
LS_167 = ["alonhadat","batdongsan","diaoconline","dothinet",\
        "homedy","mogivn","propzyvn","revervn","tinbatdongsan","youhomes"]

LS_227 = ["nhachotot","nhadatcafeland","sosanhnha","rongbay","batdongsancomvn"]

LS_167_OLD = ["alonhadat","batdongsan","diaoconline","dothinet",\
        "homedy","mogivn","propzyvn","revervn","tinbatdongsan","youhomes","batdongsancomvn"]

LS_227_OLD = ["nhachotot","nhadatcafeland","sosanhnha","rongbay"]
