...
--
-- Host: localhost:3306
-- Generation Time: Jun 02, 2020 at 01:34 PM
...
CREATE TABLE `MOGIVN` (
  ...
  `FRONTAGE` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
  `ALLEY_ACCESS` mediumtext CHARACTER SET utf8 COLLATE utf8_unicode_ci,
...
/* Have to use COLLATE=utf8mb4_unicode_ci, to store Emoji in DB */
--
