...
mkdir -p "${folder}" "${all_folder}" "${delta_folder}" "${list_folder}" "${log_folder}" "${sale_folder}" "${lease_folder}" "${house_sale_folder}" \
          "${apartment_sale_folder}" "${house_lease_folder}" "${apartment_lease_folder}" 
