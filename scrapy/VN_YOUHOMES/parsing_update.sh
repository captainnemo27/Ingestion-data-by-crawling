...
find "${ALL_FOLDER}" -type f -name '*.html' -exec python3 ../real-estate-crawl/realestatevn/python-parser/real_estate_data_parser.py {} ../real-estate-crawl/realestatevn/configs/youhomes.yml \; > "${update_file}"
